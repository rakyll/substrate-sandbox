...
//
//	go build -ldflags "-X main.defaultGuestAPIImage=... -X main.defaultAteomImage=..."
//
// The release workflow publishes digest-pinned substrate-guest-api and
